...
def grafica(f=None):
    ...
    x, y = metodo_euler(funcion_diferencial, x0, y0, xf, h)

    # Graficar los datos y la curva ajustada
    plt.plot(x, y, color='red', label='Solución por método de Euler')
...
def imprimirEuler(x, y):
    os.system("cls")
    print("\nValores calculados con el método de Euler:")
